...
CREATE TABLE `emprestimo` (
  ...
  KEY `fk_emprestimo_avalicao1_idx` (`avaliacao_idavaliacao`),
  KEY `fk_emprestimo_multa1_idx` (`multa_idmulta`),
  KEY `fk_emprestimo_patrimonio1` (`patrimonio_idpatrimonio`),
  KEY `fk_emprestimo_usuario1` (`usuario_idusuario`),
  CONSTRAINT `fk_emprestimo_avalicao1` FOREIGN KEY (`avaliacao_idavaliacao`) REFERENCES `avaliacao` (`idavaliacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_emprestimo_multa1` FOREIGN KEY (`multa_idmulta`) REFERENCES `multa` (`idmulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tipo` VALUES (1,'Curso Técnico');
...
CREATE TABLE `valor` (
  ...
  `multa_idmulta` int(11) NOT NULL,
  PRIMARY KEY (`idvalor`),
  KEY `fk_valor_multa1_idx` (`multa_idmulta`),
  CONSTRAINT `fk_valor_multa1` FOREIGN KEY (`multa_idmulta`) REFERENCES `multa` (`idmulta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_curso_has_aluno_insert`(pmatricula double, pcurso int, paluno int)
BEGIN
insert into curso_has_aluno (matricula, curso_idcurso, aluno_idaluno)
values (pmatricula, pcurso, paluno);

select matricula, curso_idcurso, aluno_idaluno from curso_has_aluno where id_curso_has_aluno = LAST_INSERT_ID();
...
select idcurso from curso where idcurso = LAST_INSERT_ID();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
insert into livro (isbn, nome_livro, ano_livro, assunto, status_livro, edicao, editora_ideditora, area_idarea)
...
select idpatrimonio, livro_idlivro from patrimonio where idpatrimonio = LAST_INSERT_ID();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-05-05  8:45:27

...
INSERT INTO `aluno` VALUES (2,0,3),(3,0,4);
...
INSERT INTO `area` VALUES (1,'Informática'),(2,'Literatura'),(3,'Literatura'),(4,'Informática'),(5,'Química');
...
INSERT INTO `autor` VALUES (4,'William Shakespeare'),(5,'José de Alencar'),(6,'J. K. Rowling');
...
INSERT INTO `avaliacao` VALUES (4,'Livro Muito Bom',4);
...
INSERT INTO `cargo` VALUES (1,'Professor',0),(2,'Professor',0),(3,'Bibliotecário',1),(4,'Coordenador',2),(5,'Secretária',0),(6,'Auxiliar de Limpeza',0),(7,'Guarda',0);
...
INSERT INTO `curso` VALUES (2,'Informática para Internet',3),(3,'Logística',3),(4,'Segurança do Trabalho',3);
...
CREATE TABLE `curso_has_aluno` (
  `idcurso_has_aluno` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `curso_has_aluno` VALUES (2,2,2,1);
...
INSERT INTO `editora` VALUES (2,'Nova Tec'),(3,'Objetiva'),(4,'Rocco'),(5,'FNAC');
...
INSERT INTO `emprestimo` VALUES (4,'2018-05-06 23:07:31','2018-05-06 23:07:31',15111991,5);
...
INSERT INTO `endereco` VALUES (3,'Travessa Júlio Guerra','Quadra 19 Lote 05',0,'Setor Central',75020320,'Anápolis','GO'),(4,'Rua Amazonas','Quadra 19 Lote 05',5,'Setor Central',75024080,'Anápolis','GO'),(5,'Avenida Senador Ramos Caiado','Quadra 19 Lote 05',145,'Maracanã',75040320,'Anápolis','GO');
...
INSERT INTO `formacao` VALUES (2,'Ensino Fundamental Incompleto'),(3,'Ensino Superior Completo'),(4,'Ensino Fundamental Completo'),(5,'Ensino Médio Completo');
...
INSERT INTO `funcionario` VALUES (2,5,7,5);
...
INSERT INTO `livro` VALUES (2,'8585851414','Romeu e Julieta',2003,'Romance Jovem',1,'1',2,4);
...
CREATE TABLE `livro_has_autor` (
  `idlivro_has_autor` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `livro_has_autor` VALUES (2,2,4);
...
INSERT INTO `patrimonio` VALUES (15111991,2);
...
INSERT INTO `senha` VALUES (3,'abcd1234','2018-05-06 22:56:21',3),(4,'qwer1234','2018-05-06 22:57:43',4),(5,'asdf1234','2018-05-06 23:02:18',5);
...
INSERT INTO `tipo` VALUES (3,'Técnico'),(4,'EAD'),(5,'Profissionalizante');
...
INSERT INTO `usuario` VALUES (3,'Fernanda de Oliveira','04174145545',6233214545,62992451245,'Fernanda@gmail.com','2000-12-10',0,'2018-05-06 22:56:21','2018-05-06 22:56:21',3),(4,'Gabriella Telles','07885589621',6233882524,62914578555,'Gabriela@gmail.com','1994-03-29',0,'2018-05-06 22:57:43','2018-05-06 22:57:43',4),(5,'Paulo de Oliveira','06665223232',6233142122,62984235656,'paulo@gmail.com','1997-08-05',0,'2018-05-06 23:02:18','2018-05-06 23:02:18',5);
...
INSERT INTO `valor` VALUES (2,1.5);
/*!40000 ALTER TABLE `valor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'libraryitego'
--
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_cargo_insert`(pnome_cargo text, pnivel int)
BEGIN
insert into cargo (nome_cargo, nivel)
values (pnome_cargo, pnivel);
...
select curso_idcurso, aluno_idaluno, matricula from curso_has_aluno where idcurso_has_aluno = LAST_INSERT_ID();
...
select livro_idlivro, autor_idautor from livro_has_autor where idlivro_has_autor = LAST_INSERT_ID();
...
-- Dump completed on 2018-05-06 23:08:58
